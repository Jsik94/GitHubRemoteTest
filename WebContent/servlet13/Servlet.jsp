...
<body>
	<fieldset>
		...
		<ul>
			...
			<li>
				<h4>get/post에 상관없이 요청받기(하나의 컨트롤러로 GET/POST방식 둘다처리)</h4>
			...
			<li>
			<!-- 굉장히 많이 발생하는 논리적 오류임 항상 어떤방식으로 보내고 해당 컨트롤러가 어떤 방식을 처리하는지 인지해야한다. -->
