...
<div class="container">
   ...
   <div>
      ...
      <form id="myform" class="form-horizontal" method="post" enctype="multipart/form-data" action="/dataroom/Edit.kosmo">
         ...
         <div class="form-group">
            ...
            <div class="col-sm-8">
               ...
               <p class="help-block">기존 첨부파일 : ${record.attachfile }</p>
            </div>
         </div>
         <div class="form-group">
            ...
            <div class="col-sm-4">
               <input type="password" class="form-control" name="password"
                  placeholder="비밀번호를 입력하세요" value=${record.password }>
            </div>
         </div>
